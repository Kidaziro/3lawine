...
document.addEventListener("DOMContentLoaded", function () {
  ...
  image.src =
    "https://github.com/Kidaziro/3lawine/blob/main/image_processing20200803-12829-111f0pe.gif?raw=true"; // Replace with the path to your imag
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  infoP.innerHTML = `عملائنا الكرام،<br>
                    مرحباً بكم في منصتنا التجارية الشاملة عبر الإنترنت. في متجركم علوان، تتمثّل رسالتنا في توفير تجربة تسوق متميزة لكم من خلال مجموعة واسعة من أفضل المنتجات عالية الجودة.
...
.span,.span-02,.span-03,.span-04,.span-05,.span-06 {
  text-align: right;
  padding: 15px 0;
  background : none; 
  color : white;
...
.span::after,.span-02::after,.span-03::after,.span-04::after,.span-05::after,.span-06::after {
  float: left;
  color: #747474;
  content: "▾";
}
...
#touch,#touch-02,#touch-03,#touch-04,#touch-05,#touch-06 {position: absolute; opacity: 0; height: 0px; }
...
#touch-05:checked + .slide-05 {height: 49px;} 
#touch-06:checked + .slide-06 {height: 49px;} 
  ...
  <ul class="slide" style="color:white">
    <li>
        ...
        <input type="checkbox" id="touch-02"> 
    ...
    <li>
      ...
      <input type="checkbox" id="touch-03"> 
    ...
    <span class="span-04">قسم الأطفال</span>
      ...
      <input type="checkbox" id="touch-04"> 
    ...
    <span class="span-05">قسم المستلزمات المنزلية</span>
      ...
      <input type="checkbox" id="touch-05"> 
    ...
    <span class="span-06">قسم الإلكترونيات</span>
      ...
      <input type="checkbox" id="touch-06"> 
  ...
  originalLi.parentNode.replaceChild(newLi, originalLi);
